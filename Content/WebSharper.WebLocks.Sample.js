...
function Main(){
  ...
  const b=(t.h.push(EventQ2(t.k, "acquirelock", () => t.i, () => {
    const _3=null;
    StartImmediate(Delay(() => Bind(AsAsync(acquireLock()), () => Return(null))), null);
  })),t);
...
function acquireLock(){
  ...
  return new Promise((_2) => {
    _2(globalThis.navigator.locks.request("my-lock", () => {
      const _3=null;
      return new Promise((_4) => {
        _4((statusMessage().Set("Lock acquired!"),console.log("Lock acquired, doing some work..."),OfAsync(Sleep(3000)).then(() => {
          console.log("Work done, releasing lock...");
          statusMessage().Set("Lock released!");
...
function CompleteHoles(key, filledHoles, vars){
  ...
  return[append(filledHoles, choose((_1) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      }):ty===4?_c_15.GetOrAddHoleFor(key, name, () => new _c_20(name, _c_11.Create_1([]))):ty===5?_c_15.GetOrAddHoleFor(key, name, () => new _c_21(name, _c_11.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_15.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_11.Create_1(o==null?[]:o.$0);
...
function unwrapExn(x){
  return x instanceof Error?x:new _c_13(x);
}
function OfAsync(a){
...
let _c_7=Lazy((_i) => class $StartupCode_Client {
  ...
  static {
    this.statusMessage=_c_11.Create_1("Lock status: Not acquired");
  }
});
function NewGuid(){
...
let _c_15=Lazy((_i) => class TemplateInitializer extends _c {
  ...
  static {
    _c_15.initialized=new _c_10("New_5");
    _c_15.instances=new _c_10("New_5");
  }
});
let _c_16=Lazy((_i) => {
  Force(_c_3);
